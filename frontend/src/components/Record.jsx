...
function Record() {
    ...
    const handleSubmit = async () => {
        try {
            const room = await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/api/room/${state.selectedRoom}`);
            const appointments = await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/api/room/${state.selectedRoom}/service/${state.selectedService}/appointment`)
            setState(prevState => {
                return {
                    ...prevState,
